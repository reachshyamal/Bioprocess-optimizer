...
d <- as.data.frame(read_excel("Master_data_upstream_16102017.xlsx",sheet="Downstream structured",skip=1))
dh <- as.data.frame(read_excel("Master_data_upstream_16102017.xlsx",sheet="HA chromatography"))
d <- d[d$X__2 > 640,]
